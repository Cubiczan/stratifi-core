...
from cme.cfo_os.briefs import BoardBrief, CFOBrief, CFOTaskType, ForecastBrief, InvestmentBrief, SweepBrief
...
class CFOOperatingSystem:
    ...
    def _build_artifact(
        ...
        if isinstance(brief, SweepBrief):
            return build_sweep_pack(brief=brief, case=case, turns=turns)
